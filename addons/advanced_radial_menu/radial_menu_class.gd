...
@export								var move_forward_action_name := 'arriba'
@export								var move_left_action_name := 'izq'
@export								var move_back_action_name := 'abajo'
@export								var move_right_action_name := 'der'
